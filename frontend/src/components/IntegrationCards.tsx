...
import { Gamepad2, Sword, Trophy, X, ExternalLink } from "lucide-react-native";
  ...
  return (
    <View style={styles.card} testID="steam-connect-card">
      <View style={styles.header}>
        <View style={[styles.iconWrap, { backgroundColor: colors.primarySoft, borderColor: colors.borderStrong }]}>
        ...
        {linked ? (
          ...
          <TouchableOpacity testID="steam-connect-btn" onPress={link} style={styles.connectBtn} disabled={busy}>
            {busy ? <ActivityIndicator size="small" color="#FFFFFF" /> : <Text style={styles.connectText}>Connect</Text>}
          </TouchableOpacity>
        )}
      </View>
        ...
        <View style={styles.modalBackdrop}>
          <View style={styles.modalCard}>
            ...
            <TouchableOpacity testID="riot-link-submit" style={[styles.primary, busy && { opacity: 0.5 }]} onPress={link} disabled={busy}>
              {busy ? <ActivityIndicator color="#FFFFFF" /> : <Text style={styles.primaryText}>Link Account</Text>}
            </TouchableOpacity>
...
const makeStyles = (colors: ColorPalette) => StyleSheet.create({
  ...
  connectBtn: { backgroundColor: colors.primary, paddingHorizontal: 16, paddingVertical: 8, borderRadius: radius.pill, minWidth: 90, alignItems: "center" },
  ...
  champsLabel: { color: colors.accent, fontSize: 10, fontWeight: "800", letterSpacing: 1 },
  champTag: { flexDirection: "row", alignItems: "center", gap: 4, backgroundColor: colors.accentSoft, borderWidth: 1, borderColor: colors.accent, paddingHorizontal: 8, paddingVertical: 4, borderRadius: radius.sm },
  champTagText: { color: colors.textPrimary, fontSize: 11, fontWeight: "700" },
  champTagPts: { color: colors.textMuted, fontSize: 10 },
  modalBackdrop: { flex: 1, backgroundColor: colors.overlayBackdrop, justifyContent: "flex-end" },
  ...
  primary: { backgroundColor: colors.primary, padding: 14, borderRadius: radius.pill, alignItems: "center", marginTop: spacing.md },
